...
export namespace GameResult {
  ...
  // the tagged union.
  export type Winner = { tag: "Winner", value: __FieldState };
  ...
  // assert!(foo.value === 42);
  // ```
  export const Winner = (value: __FieldState): GameResult => ({ tag: "Winner", value });
  export const Draw = { tag: "Draw" };

  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createSumType([
      new SumTypeVariant("Winner", __FieldState.getTypeScriptAlgebraicType()),
...
export type GameResult = GameResult.Winner | GameResult.Draw;
